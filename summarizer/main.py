...
def main():
    """
    1) init DB
    2) user input -> create subdir in results
    3) if video, convert -> audio.wav
    4) diarize/transcribe -> store in DB & local
    5) summarize -> store final summary
    """
    init_db()
    ...
    print("Summarizing transcript (GPT + HF + chunk-level scoring)...")
