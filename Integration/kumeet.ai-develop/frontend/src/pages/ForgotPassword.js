...
const ForgotPassword = () => {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      tempSuccess.className = 'text-sm text-green-600 mt-2';
      tempSuccess.textContent = 'Reset link resent successfully!';
      const resendButton = document.querySelector('#resend-button');
      resendButton.parentNode.appendChild(tempSuccess);
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-4 flex flex-col space-y-2">
                  ...
                  >
                    {resending ? 'Sending...' : "Didn't receive the email? Click to resend"}
                  </button>
                  <Link
